...
try:
    ...
    try:
        ...
        with st.spinner(
            "🤖 Loading YOLO model... First run may take a little longer."
        ):
        ...
        st.info(
            ...
            "the YOLO model needs to be loaded."
        )
    ...
    if not cap.isOpened():
        ...
        st.info(
            "Try uploading a normal MP4 video."
        )
